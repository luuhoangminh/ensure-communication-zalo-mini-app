...
export const NEWS_LIST_PAGE = {
  ...
  pageSizeOption: process.env.NEWS_LIST_PAGE_SIZE_OPTION_SELECTOR!,
  bannerField: process.env.NEWS_LIST_BANNER_FIELD_SELECTOR!,
  radioGroup: process.env.NEWS_LIST_RADIO_GROUP_SELECTOR!,
  titleField: process.env.NEWS_LIST_TITLE_FIELD_SELECTOR!,
  publicationTimeField: process.env.NEWS_LIST_PUBLICATION_TIME_FIELD_SELECTOR!,
  categoryDropdown: process.env.NEWS_LIST_CATEGORY_DROPDOWN_SELECTOR!,
